...
export default function Health() {
  ...
  async function handleSave() {
    ...
    const { error: insertError } = await supabase.from('health_records').insert({
      dog_id: dogId, record_type: newType, title: newTitle,
    ...
    setNewTitle(''); setNewDate(''); setNewNextDate(''); setNewNotes(''); setNewType('vaccine');
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.modalContent}>
            ...
            {formStep === 'form' && (
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TouchableOpacity style={styles.datePickerButton} onPress={() => setFormStep('pick_date')}>
                ...
                <TouchableOpacity style={styles.datePickerButton} onPress={() => setFormStep('pick_next_date')}>
            ...
            {(formStep === 'pick_date' || formStep === 'pick_next_date') && (
              <View>
                ...
                <Calendar
                  onDayPress={day => {
                    if (formStep === 'pick_date') setNewDate(day.dateString);
                    else setNewNextDate(day.dateString);
                    setFormStep('form');
                  }}
      ...
      <View style={styles.viewToggle}>
        ...
        <TouchableOpacity style={[styles.toggleBtn, view === 'calendar' && styles.toggleBtnActive]} onPress={() => setView('calendar')}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.card}>
                ...
                {item.next_date ? <Text style={styles.nextDateText}>🔔 Sonraki: {formatDate(item.next_date)}</Text> : null}
                {item.notes ? <Text style={styles.notesText}>{item.notes}</Text> : null}
              </View>
            )}
          />
