...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: COLORS.cream, padding: 24, paddingTop: 64 },
  ...
  card: { backgroundColor: COLORS.white, borderRadius: 24, padding: 20, marginBottom: 16, ...SHADOW },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  cardTitle: { fontSize: 14, fontWeight: '800', color: COLORS.ink },
  cardDesc: { fontSize: 12, color: COLORS.sand, marginTop: 8, lineHeight: 18 },
  button: {
    backgroundColor: COLORS.clay, borderRadius: 16, paddingVertical: 16, alignItems: 'center', marginTop: 16,
  },
